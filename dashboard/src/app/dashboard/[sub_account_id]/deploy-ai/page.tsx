...
export default async function DeployAIRepsPage({ params }: Props) {
    const { sub_account_id } = await params
    const data = await getChecklistData('deploy_ai_reps', sub_account_id)
            ...
            <div className="p-6">
                <div className="rounded-xl border bg-card p-8 text-center">
                    ...
                    <p className="text-muted-foreground">
                        The Deploy AI Reps setup guide has not been configured yet.
    ...
    return (
        <div className="p-6">
            ...
            <ChecklistSectionCards
                ...
                basePath={`/dashboard/${sub_account_id}/deploy-ai`}
            />
        </div>
    )
}
