...
export default async function VoiceAIConfigPage({ params }: Props) {
    const { sub_account_id } = await params
    const data = await getChecklistData('voice_ai_config', sub_account_id)
            ...
            <div className="p-6">
                <div className="rounded-xl border bg-card p-8 text-center">
                    ...
                    <p className="text-muted-foreground">
                        The Voice AI Rep setup checklist has not been configured yet.
    ...
    return (
        <div className="p-6">
            ...
            <ChecklistSectionCards
                ...
                basePath={`/dashboard/${sub_account_id}/voice-ai/config`}
            />
        </div>
    )
}
